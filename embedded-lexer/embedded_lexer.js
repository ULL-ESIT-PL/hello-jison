...
case 2:
    ...
    this.$ = {type: yy.E, rightside: [yyvstack[yysp - 2], { type: yy["+"], value: '+', loc: yylstack[yysp - 2]}, yyvstack[yysp]]}
    break;
...
case 3:
    ...
    this.$ = {type: yy.E, rightside: [yyvstack[yysp]]}
    break;
...
case 4:
    ...
    this.$ = { type: yy.T, rightside: [{ type: yy.NAT, value: yyvstack[yysp], loc: yylstack[yysp]}] }
    break;
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = embedded_lexer;
  exports.Parser = embedded_lexer.Parser;
  exports.parse = function () {
    return embedded_lexer.parse.apply(embedded_lexer, arguments);
  };
